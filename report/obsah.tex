...
Z grafu lze vyèíst, ¾e je program \texttt{gambit-enummixed} rychlej¹í pro poèet strategií $2$ a¾ $11$. Za pøedpokladu, ¾e by byla zachována stejná tendence rùstu obou funkcí, je mo¾no pøedpovídat, ¾e by mùj program \texttt{neng} program \texttt{gambit-enummixed} pøedèil v nároènìj¹ích hrách.
...
¾ádná dal¹í z nich v¹ak nezvládla spolehlivì dokonvergovat k výsledku s dostateènou pøesností a s maximálním poètem vyhodnocení objektivní funkce.

Testovací skupina her byla pøevzata z nástroje \texttt{Gambit}, a jsou to stejné hry, které byly pou¾ity v èlánku~\cite{pavlidis2005computing} a známé hry jako matching pennies~\ref{tab:matching_pennies} a vìzòovo dilema~\ref{tab:prisoners_dilemma}. Jsou to hry následující (v¹echny tyto hry jsou k nalezení na pøilo¾eném CD):
