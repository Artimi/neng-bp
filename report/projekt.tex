...
\projectinfo{
  ...
  %Nazev prace
  title.cs={Nástroj pro výpoèet Nashova ekvilibria v nekooperativních hrách s nenulovým souètem},  %nazev prace v cestine
  title.en={A Tool for Computing Nash Equilibria}, %nazev prace v anglictine
  %Autor
  author={Petr ©ebek},   %jmeno prijmeni autora
  %author.title.p=Bc., %titul pred jmenem (nepovinne)
  %author.title.a=PhD, %titul za jmenem (nepovinne)
  %Ustav
  department=UITS, % doplnte prislusnou zkratku: UPSY/UIFS/UITS/UPGM
  %Skolitel
  supervisor= Martin Hrubý, %jmeno prijmeni skolitele
...
\newtheorem{definition}[definitioncounter]{Definice}

\theoremstyle{theorem}
\newcounter{propositioncounter}
\renewcommand{\thepropositioncounter}{\arabic{propositioncounter}}
\newtheorem{proposition}[propositioncounter]{Vìta}
\begin{document}
